...
function InfoPage() {
    const { setOpened, setSearch } = useAuth();
    ...
    useEffect(() => {
        setSearch(null);
        setId("63b412e2aa2e4bfdb072dcf871ed84c4");
    }, []);
    ...
    return (
        <div className="h-screen overflow-scroll overflow-x-hidden w-full text-gray-600 dark:text-white p-10 example">
                    ...
                    <div>
                        <div className="max-h-[400px]">
                            <img onError={(e)=>{
                                    ...
                                    }} src={data.image_url} alt="item" className="max-h-[400px] max-w-screen object-contain rounded-lg shadow-lg mb-5" />
                        </div>
                        <div>
